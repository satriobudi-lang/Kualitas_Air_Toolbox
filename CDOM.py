...
class CDOM(object):
    ...
    def execute(self, parameters, messages):
        ...
        Green = parameters[0].valueAsText
        Vegetation_red_edge = parameters[1].valueAsText
        ...
        with arcpy.EnvManager(scratchWorkspace=r"[YOUR PATH]", workspace=r"[YOUR PATH]"):
            out_rc_minus_raster = arcpy.sa.RasterCalculator(([Green,Vegetation_red_edge]), ["x","y"], "(x/y)")
